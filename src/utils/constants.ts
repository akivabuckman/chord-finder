...
export const romanChordsToMetaData: {[key: string]: {
  ...
  'vi': { accidental: '', degree: '6', quality: 'm', seventh: '', explanation: "The vi chord. The minor 'home', relative minor of the major 'home'" },
  'viio': { accidental: '', degree: '7', quality: '°', seventh: '', explanation: 'The vii° chord. Diminished chord built on the 7th degree, leads strongly to I' },
  ...
  'IM': { accidental: '', degree: '1', quality: '', seventh: 'maj7', explanation: "The I chord, the 'home'. Contains notes 1, 3, 5" },
  'iim': { accidental: '', degree: '2', quality: 'm', seventh: '7', explanation: "The ii chord. A step away from 'home'. Contains the 2, 4, 6" },
  'iiim': { accidental: '', degree: '3', quality: 'm', seventh: '7', explanation: "The iii chord. Away from 'home' but still familiar. Contains the 3, 5, 7" },
  'IVM': { accidental: '', degree: '4', quality: '', seventh: 'maj7', explanation: "The IV chord. Takes us away from 'home'" },
  ...
  'bVIM': { accidental: 'b', degree: '6', quality: '', seventh: 'maj7', explanation: "The flat 6's major chord. 'Borrowed' from the minor scale and often leads into bVII and then resolves to the major root" },
  ...
  'viiom': { accidental: '', degree: '7', quality: '°', seventh: '7', explanation: "The vii° chord. Diminished chord built on the 7th degree, leads strongly to I" },
  ...
  'IIM': { accidental: '', degree: '2', quality: '', seventh: 'maj7', explanation: "The major II chord. Augments the 4th note to add brightness" },
  'IIIM': { accidental: '', degree: '3', quality: '', seventh: 'maj7', explanation: "I'll add this explanation soon!" },
  'VM': { accidental: '', degree: '5', quality: '', seventh: 'maj7', explanation: "The V chord. Major chord built on the 5th degree, creates tension that resolves to I" },
